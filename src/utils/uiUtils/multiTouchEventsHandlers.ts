...
import { IosTouch, MultiTouchHandlers, AnyPointerEvent } from '../../types/eventsTypes'
...
import getPointerEventForThisDevice from '../domUtils/getPointerEventForThisDevice'
...
const multiTouchEventsHandlers = (
  ...
  // @ts-expect-error it doesn't like a variable event name
  target.addEventListener(eventStart, handleTouchStart) // eslint-disable-line
}
